...
public class InstructionScreen extends BorderPane {
    ...
    public InstructionScreen(MainApp app) {
        ...
        // changeScreenBack.setStyle("-fx-effect: dropshadow(three-pass-box,
        // rgba(0,0,0,0.7), 5, 0.0, 0, 1)");
        // changeScreenBack.setStyle(
        // "-fx-font: 22 fantasy; -fx-background-color: #b30768, linear-gradient(#9c2f6c
        // 0%, #291f29 20%, #221921 100%), linear-gradient(#e000c6, #c732c2),
        // radial-gradient(center 50% 0%, radius 100%, #fc6af0, #ff00d4)");
        ...
        // changeScreenPlay.setStyle("-fx-effect: dropshadow(three-pass-box,
        // rgba(0,0,0,0.7), 5, 0.0, 0, 1)");
